        ...
        <div className="events__body">
          {events.map((event, index) => (
            <div className="events__history" key={index}>
              <button
                type="button"
                className="events__edit-btn"
                onClick={() => handleEditBtn(event, index)}
              ></button>
              <button
                type="button"
                className="events__delete-btn"
          ...
          <form className="events__form" onSubmit={handleFormSubmit}>
            <div className="events__inputs-container">
              <label className="events__label" htmlFor="eventAge">
                Возраст
              </label>
              <input
                value={eventAge}
                ...
                id="eventAge"
              />
              <label className="events__label" htmlFor="eventDescription">
                Событие
              </label>
              <textarea
                ...
                className="events__input events__textarea"
                id="eventDescription"
              />
            </div>
            <SubmitButton
